...
class TestDiagonalSudoku(unittest.TestCase):
    ...
    def test_diagonals(self):
        ...
        self.assertCountEqual(solution.diagonalUnits, diagonal)
...
class TestUnits(unittest.TestCase):
    ...
    unitsA1 = [row1, col1, square1, diagonal1]

    def test_unitA(self):
        self.assertCountEqual(
            solution.units['A1'], self.unitsA1)

    def test_peersA(self):
        peers = {box for u in self.unitsA1 for box in u if box != 'A1'}
        self.assertCountEqual(
            solution.peers['A1'], peers)
